...
- [5.2 유기동물 조회](#52-유기동물-조회)
  - [5.2.1 후원하기](#521-후원하기)
  - [5.2.2 임시보호하기](#522-임시보호하기)
  - [5.2.3 입양하기](#523-입양하기)
- [5.3 반려동물 찾아요 & 유기동물 봤어요](#53-반려동물-찾아요--유기동물-봤어요)
  - [5.3.1 검색 기능](#531-검색-기능)
  - [5.3.2 매칭 기능](#532-매칭-기능)
- [5.4 게시판](#54-게시판)
  - [5.4.1 게시판 종류](#541-게시판-종류)
  - [5.4.2 공개글 & 비공개글](#542-공개글--비공개글)
  - [5.4.3 댓글 기능](#543-댓글-기능)
- [5.5 관리자 페이지](#55-관리자-페이지)
  - [5.5.1 도메인 관리](#551-도메인-관리)
  - [5.5.2 입양/임보 승인, 거절 기능](#552-입양임보-승인거절-기능)
...
## 5.4 게시판
### 5.4.1 게시판 종류
- 게시판은 자유, 문의, 입양 후기 게시판 3종류의 게시판이 있습니다.
...
### 5.4.2 공개글 & 비공개글
- 게시글 작성시 게시글의 공개 여부를 설정할 수 있습니다.
...
### 5.4.3 댓글 기능
### (1) 로그인한 회원은 게시글에 댓글을 작성할 수 있습니다.
...
### (2) 로그인하지 않은 회원은 게시글과 댓글을 작성할 수 없습니다.
- 게시글 작성을 시도하는 경우 로그인 화면으로 이동합니다.
  - 로그인을 하면, 접근했던 페이지로 이동합니다.
  - ex) 자유 게시글 작성 -> 로그인 -> 자유 게시글 작성
- 로그인 하지 않은 회원은 댓글 작성창이 뜨지 않습니다.
