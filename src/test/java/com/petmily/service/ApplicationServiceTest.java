...
//        Long adoptId = applicationService.adopt(member.getId(), animal.getId(), adoptDto);
//
//        ChangeAdoptForm changeAdoptForm = new ChangeAdoptForm();
//        changeAdoptForm.setAddress("addressB");
//        changeAdoptForm.setJob("teacher");
//        changeAdoptForm.setMarried(true);
//
//        //when
//        applicationService.changeAdoptInfo(adoptId, changeAdoptForm);
//
//        Adopt adopt = applicationService.findOne(adoptId, Adopt.class);
//
//        //then
//        assertThat(adopt.getLocation()).isEqualTo(changeAdoptForm.getAddress());
//        assertThat(adopt.getJob()).isEqualTo(changeAdoptForm.getJob());
//        assertThat(adopt.getMarried()).isEqualTo(changeAdoptForm.getMarried());
...
//        Long tempProtectId = applicationService.tempProtect(member.getId(), animal.getId(), tempProtectionDto);
//
//        ChangeTempProtectionForm changeTempProtectionDto = new ChangeTempProtectionForm();
...
//        Long donateId = applicationService.donate(member.getId(), animal.getId(), donationDto);
//
//        ChangeDonationForm changeDonationForm = new ChangeDonationForm();
//        changeDonationForm.setAmount(10000000);
//
//        //when
//        applicationService.changeDonationInfo(donateId, changeDonationForm);
//        Donation donation = applicationService.findOne(donateId, Donation.class);
//
//        //then
//        assertThat(donation.getAmount()).isEqualTo(changeDonationForm.getAmount());
